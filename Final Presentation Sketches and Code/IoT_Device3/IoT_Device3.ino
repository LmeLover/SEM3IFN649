/*
This is IoT Device 3, the display.
This device uses 2 8 Dot Matrix Displays, 3 LEDs and a Buzzer.
The display is dependent on the mode IoT Device 1 is in, and it will display the readings.
*/
#define LED_GREEN    1
#define LED_ORANGE   2
#define LED_RED      3
