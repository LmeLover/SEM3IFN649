/*
This is IoT Device 2, the mode selector.
This device uses a rotary encoder and 4 LEDs
You select the mode with the rotary encoder which is reflected on the LED.
Red is Mode 0 - Off
Green is Mode 1 - Temperature and Tilt (default)
Orange is Mode 2 - Temperature Only
Yellw os Mode 3 - Tilt Only
*/
